...
import * as WL from '../lib/wishlist.js'; // ✅ библиотека вишлиста
...
function getImageCandidates(p) {
  const cand = [
    ...
    p.urls && p.urls.main,
    p.files && p.files.main,
  ].filter(Boolean).map(makeAbs);

  // Добавьте больше вариантов путей
  const bases = [
  ...
  if (cand.length === 0) {
    console.log('Продукт без изображений:', p.id, p);
  }
...
export default function Home() {
  ...
  // текущее множество для отображения
  ...
  // Кнопка «в корзину» как раньше (переходим на страницу товара)
                      ...
                      <div className="pcard-price">
                        ...
                        >
                          <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M19 2.5H4.21L3.27 0.5H0V2.5H2L5.6 10.09L4.24 12.54C4.09 12.82 4 13.15 4 13.5C4 14.0304 4.21071 14.5391 4.58579 14.9142C4.96086 15.2893 5.46957 15.5 6 15.5H18V13.5H6.42Z" fill="#35C65E" mask={`url(#cart-${p.id})`} />
